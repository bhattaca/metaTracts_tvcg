...
\begin{figure}[htb]
	...
	\caption{MetaTracts FiberScout Workflow. \todo{TODO: add more info}}
	\label{fig:flowchart}
\end{figure}
...
\begin{figure}[htb]
	...
	\caption{The FiberScout's graphical user interface with a loaded MetaTracts approach for a fiber bundle extraction. \todo{TODO: add more info}}
	\label{fig:flowchart}
\end{figure}
